<?php 
include 'koneksi.php';
$query = mysqli_query($koneksi,"SELECT * FROM pengobatan JOIN pasien ON pengobatan.id_pasien = pasien.id_pasien JOIN dokter ON pengobatan.id_dokter = dokter.id_dokter");
?>
<!DOCTYPE html>
<html lang="en">
<head>
